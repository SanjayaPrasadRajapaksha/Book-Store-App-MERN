    ...
    <div className='px-4 my-12'>
      ...
      <Table className="lg:w-[1180px]">
        <Table.Head>
          ...
          <Table.HeadCell>Pricea</Table.HeadCell>
          <Table.HeadCell>
          ...
          allBooks.map((book, index) => <Table.Body className="divide-y" key={book._id}>
            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
              ...
              <Table.Cell>
                ...
                <button onClick={() => handleDelete(book._id)} className="bg-red-600 px-4 py-1 dont-semibold text-white rounded-sm hover:bg-sky-600">Delete</button>
              </Table.Cell>
            </Table.Row>
          </Table.Body>)
        }
