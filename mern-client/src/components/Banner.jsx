        ...
        <div className='px-4 lg:px-24 bg-teal-100 flex items-center'>
            <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
                ...
                <div className='md:w-1/2 space-y-8 h-full'>
                    ...
                    <p className='md:w-4/5'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Provident quis 
                    aliquid dolorum voluptatibus animi sunt mollitia culpa. Voluptate, beatae rem sapiente ipsa excepturi 
                    similique hic quos tempore qui, ullam corrupti.
                    </p>
                    <div>
